...
// Liste de flux RSS réduite pour accélérer
const RSS_FEEDS = [
...
async function fetchNewsFromRSS(rssUrl) {
  try {
    ...
    // Récupérer seulement 2 articles par flux pour ultra-rapidité
...
app.listen(PORT, () => {
  ...
  console.log('⚡ Version ultra-optimisée: 2 articles par flux RSS');
});
